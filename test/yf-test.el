...
(ert-deftest yf-sum-test ()
  ...
  (should (equal (yf-eval-postfix "2 3 4 5 sum")
                 '((14 . "ANY"))))
  (should (equal (yf-eval-postfix "4 USD 1 USD 6 EUR 2 EUR sum")
                 '((8 . "EUR") (5 . "USD"))))
  (should (equal (yf-eval-postfix "4 USD 1 USD 10 GBP 6 EUR 2 EUR sum")
                 '((8 . "EUR") (10 . "GBP") (5 . "USD"))))
  (should (equal (yf-eval-postfix "4 USD 2 1 USD 10 GBP 6 EUR 2 EUR 1 sum")
                 '((9 . "EUR") (10 . "GBP") (7 . "USD"))))
  (should (equal (yf-eval-postfix "1 GBP 5 USD 8 HUF 10 EUR 20 EUR 30 EUR sum")
