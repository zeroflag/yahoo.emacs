...
(ert-deftest yf-const-test ()
  (should (equal (eval1 "3.14 const pi pi") '((3.14 . "ANY"))))
  (should (equal (eval1 "42 USD const amt amt") '((42 . "USD"))))
  (eval1 "123 const x")
  (eval1 "456 const y")
...
(ert-deftest yf-when-test ()
  (should (equal (eval1 "[ 5 2 - ] [ 4 5 < ] WHEN") '((3 . "ANY"))))
  (should (equal (eval1 "[ 42 ] [ 4 5 < ] WHEN") '((42 . "ANY"))))
  (should (equal (eval1 "100 [ drop 2 ] [ 4 5 < ] WHEN") '((2 . "ANY"))))
  (should (equal (eval1 "100 [ 2 / ] [ 4 5 < ] WHEN") '((50.0 . "ANY"))))
  (should (equal (eval1 "100 [ drop 2 ] [ 10 5 < ] WHEN") '((100 . "ANY"))))
  (should (equal (eval1 "100 [ 2 / ] [ 10 5 < ] WHEN") '((100 . "ANY")))))

(ert-deftest yf-unless-test ()
  (should (equal (eval1 "[ 5 2 - ] [ 4 5 > ] UNLESS") '((3 . "ANY"))))
  (should (equal (eval1 "[ 42 ] [ 4 5 > ] UNLESS") '((42 . "ANY"))))
  (should (equal (eval1 "100 [ drop 2 ] [ 4 5 < ] UNLESS") '((100 . "ANY"))))
  (should (equal (eval1 "100 [ 2 / ] [ 4 5 < ] UNLESS") '((100 . "ANY"))))
  (should (equal (eval1 "100 [ drop 2 ] [ 10 5 < ] UNLESS") '((2 . "ANY"))))
  (should (equal (eval1 "100 [ 2 / ] [ 10 5 < ] UNLESS") '((50.0 . "ANY")))))
